...
// https://github.com/ucb-bar/riscv-mini/blob/release/lib/src/main/scala/config/Config.scala
package mcatv
...
abstract class Parameters extends View {
  ...
  def chain[T](site: View, tail: View, pname: Field[T]): Option[T]
  def find[T](pname: Field[T], site: View) = chain(site, new TerminalView, pname)
}
...
class Config(p: Parameters) extends Parameters {
  ...
  def chain[T](site: View, tail: View, pname: Field[T]) = p.chain(site, tail, pname)
